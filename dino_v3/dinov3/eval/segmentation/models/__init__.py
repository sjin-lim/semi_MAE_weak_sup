...
from dinov3.eval.segmentation.models.heads.segformer_head import SegFormerHead
...
def build_segmentation_decoder(
    ...
    elif decoder_type in ("linear", "segformer"):
